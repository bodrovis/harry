...
<article class="book-main">
  ...
  <section class="row" id="page-287">
    ...
    <div class="column column-60">
      <p class="meh">
        Да потому что совершенно очевидно: учеников нужно отправлять по домам. Почему никто из учителей нихрена не делает? Неужели нельзя как-то попытаться хотя бы отследить перемещения этого монстра по школе? Например, установить магическое видеонаблюдение.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-288">
    <div class="column">
      <p class="text">
        ...
        — Перестаньте, пожалуйста, — жалобно умоляла она [Джинни] каждый раз, когда Фред во всеуслышанье спрашивал Гарри, кого еще он собирается погубить.
        <span class="explanation">
          Братья шуткуют.
        </span>
      </p>
  ...
  <section class="row" id="page-305">
    <div class="column">
      <p class="text">
        ...
        — Глядя на всех этих Уизли в жизни, не скажешь, что они чистокровные!<br>Физиономия Рона — точнее сказать, Крэбба — исказилась от бешенства.
        <span class="explanation">
  ...
  <section class="row" id="page-341">
    ...
    <div class="column column-60">
      <p class="meh">
        Как-то ненароком упускается тот момент, что открыть тайную комнату может только наследник Слизерина, которым Хагрид вряд ли является. А просто "поглазеть" туда зайти вряд ли получится. Хорошо, и если даже в прошлый раз комнату открыл Хагрид, то кто это сделал теперь?..
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-470">
    <div class="column">
      <p class="text">
        ...
        — Так это же был ключ, сэр, — ответил Добби [...]. — Добби вам намекнул. Ведь раньше-то Темного Лорда спокойно называли по имени. Это уж потом, когда он придумал себе новое имя, стало нельзя. Понятно?
      </p>
    </div>
    <div class="column column-60">
      <p class="bad">
