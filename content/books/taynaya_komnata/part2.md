...
<article class="book-main">
  ...
  <section class="row" id="page-265">
    <div class="column">
      <p class="text">
        ...
        Гарри занес палочку, но Малфой опередил его, начав бой на счет «два». Гарри словно кочергой по голове огрели. [...] &mdash; Я сказал, никакого насилия! &mdash; испуганно завопил Локонс [...]
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-268">
    <div class="column">
      <p class="text">
        ...
        [Гарри] улыбнулся и посмотрел на Джастина, ожидая удивления, благодарности, но встретил взгляд, полный ужаса и неприязни. &mdash; Устроил тут представление! &mdash; воскликнул тот и пулей выскочил из зала.
        <span class="explanation">
  ...
  <section class="row" id="page-271">
    <div class="column">
      <p class="text">
        ...
        &mdash; Как теперь это [что Гарри невиновен] доказать? [...] Слизерин жил тысячу лет назад. Все может быть.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-276">
    <div class="column">
      <p class="text">
        ...
        &mdash; Но я [Эрни] слышал, ты ненавидишь маглов, у которых живешь.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-300">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 300</span>
        Девушка смерила его неодобрительным взглядом: &mdash; Прошу прощения, у нас с вами разные гостиные. Я из Когтеврана.
        <span class="explanation">
  ...
  <section class="row" id="page-302">
    <div class="column">
      <p class="text">
        ...
        Перси расправил плечи: &mdash; Я &mdash; староста. Никто не осмелится на меня напасть.
        <span class="explanation">
  ...
  <section class="row" id="page-338">
    <div class="column">
      <p class="text">
        ...
        &mdash; Все кончено, Рубеус. Я все о тебе расскажу. Ведь если нападения не прекратятся, школу закроют.
        <span class="explanation">
  ...
  <section class="row" id="page-359">
    <div class="column">
      <p class="text">
        ...
        &mdash; Мне бы хотелось внести ясность, Корнелиус. Хагрид пользуется моим полным доверием.<br> Явно ощущая неловкость, Фадж продолжал. &mdash; Послушайте, Альбус, прошлое Хагрида говорит против него. У Министерства нет выхода. Необходимо действовать.
        <span class="explanation">
  ...
  <section class="row" id="page-386-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 386</span>
        &mdash; Очень многое! Хотя бы то, что Хагрид никогда не открывал Тайной комнаты.
        <span class="explanation">
  ...
  <section class="row" id="page-438">
    <div class="column">
      <p class="text">
        ...
        &mdash; Никто не знает, почему ты, сражаясь со мной, слабеешь, &mdash; сказал Гарри.
        <span class="explanation">
          Это о Волдеморте.
        </span>
      </p>
