...
<article class="book-main">
  ...
  <section class="row" id="page-3">
    <div class="column">
      <p class="text">
        ...
        &mdash; Сове в клетке скучно, &mdash; в который раз принялся объяснять Гарри. &mdash; Она вольная птица. Хорошо бы выпускать ее хоть на ночь.
    ...
    <div class="column column-60">
      <p class="meh">
        Сова в принципе не должна жить в такой клетке, судя по описанию весьма небольшой (иначе Гарри никак не смог бы в одиночку таскать её вместе с другими вещами). Кто вообще придумал рекомендовать школьникам покупать себе сов? Это весьма специфичные животные, и для их правильного содержания нужны определённые знания.
      </p>
    </div>
  </section>

  <section class="row" id="page-3-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 3</span>
        &mdash; Я что, по-твоему, идиот? Не знаю, что от сов именно ночью жди неприятностей?
        <span class="explanation">
          Дурсль негодует.
        </span>
      </p>
  ...
  <section class="row" id="page-6">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 6</span>
  ...
  <section class="row" id="page-26">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 26</span>
        &mdash; Ты [Добби] воровал мои письма?
        <span class="explanation">
  ...
  <section class="row" id="page-32">
    ...
    <div class="column column-60">
      <p class="meh">
        Почему никто из волшебников не вмешается? Это же беспредел. Гарри превратили в узника замка Иф, а никто и не думает вызволять своего "кумира". Неужели за домом всё так же никто не следит, если уже точно известно, что Волдеморт вернулся, либо вернётся в любой момент? Ведь нам же только в прошлой книге рассказывали, что Гарри важен, что ему дали шанс сразиться с Волдемортом самостоятельно и т.д. и т.п.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-42">
    ...
    <div class="column column-60">
      <p class="comment">
        А как он, прошу прощения, "заводится" в доме? Как мыши &mdash; из гнилой соломы?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-27">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 45</span>
  ...
  <section class="row" id="page-54">
    <div class="column">
      <p class="text">
        ...
        &mdash; Наши гномы глуповаты. [...] Услышат, что началось выдворение, так и лезут на поверхность. Нет, чтобы забиться поглубже в норы.
      </p>
    </div>
    <div class="column column-60">
      <p class="good">
  ...
  <section class="row" id="page-62">
    <div class="column">
      <p class="text">
        ...
        &mdash; Ну и ну! &mdash; удивился он [мистер Уизли], услыхав от Гарри про телефон. &mdash; Сколько же всего они напридумывали! А что еще им, бедным, остается делать без магии!
        <span class="explanation">
    ...
    <div class="column column-60">
      <p class="comment">
        Мистер Уизли занимается работой с маглами, судя по всему, уже много лет. И он не знает как работает телефон? Папуасы из племени Мумбо-Юмбо &mdash; и те уже знают.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-67">
    <div class="column">
      <p class="text">
        ...
        &mdash; Уж не знаю, где мама с папой возьмут денег на все покупки [...]
        <span class="explanation">
  ...
  <section class="row" id="page-68">
    <div class="column">
      <p class="text">
        ...
        &mdash; В самом деле? &mdash; с нескрываемым восторгом воскликнул мистер Уизли. &mdash; Я слыхал, там [в метро] есть лестницы-чудесницы!
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-69">
    <div class="column">
      <p class="text">
        ...
        &mdash; Косой переулок, &mdash; крикнул Фред и исчез.
        <span class="explanation">
  ...
  <section class="row" id="page-71">
    <div class="column">
      <p class="text">
        ...
        &mdash; Да где же это я? &mdash; прошептал Гарри, оглядывая большой, слабо освещенный зал.
        <span class="explanation">
  ...
  <section class="row" id="page-71-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 71</span>
        А на прилавке &mdash; кошмар! &mdash; разложены человеческие кости разных форм и размеров.
        <span class="explanation">
  ...
  <section class="row" id="page-94">
    <div class="column">
      <p class="text">
        ...
        &mdash; Только ни слова Молли, &mdash; шепнул мистер Уизли Гарри, открыв багажник. Что-то нажал, багажник раздался в ширину, и громоздкие чемоданы легко туда влезли.
        <span class="explanation">
  ...
  <section class="row" id="page-94-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 94</span>
        [...] она [Молли] немало удивилась: &mdash; Простецы не так уж глупы, как нам представляется. Такая вместительная машина! А по виду ни за что не скажешь.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-97">
    <div class="column">
      <p class="text">
        ...
        &mdash; Мы опоздаем на поезд,&mdash; упавшим голосом проговорил он. &mdash; Не понимаю, почему вход не открылся…
        <span class="explanation">
    ...
    <div class="column column-60">
      <p class="meh">
        Конечно же, больше опоздунов на поезд нет &mdash; только Гарри и Рон.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-99">
    <div class="column">
      <p class="text">
        ...
        &mdash; Мы в безвыходном положении, правда? Нам ведь надо ехать в школу! В экстренных случаях даже несовершеннолетним волшебникам разрешается применять магию.
        <span class="explanation">
  ...
  <section class="row" id="page-117">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 117</span>
        &mdash; Тебе бы, Уизли, лучше всего отправиться сейчас в изолятор, у тебя ссадина на лбу кровоточит.
      </p>
    </div>
    <div class="column column-60">
      <p class="comment">
  ...
  <section class="row" id="page-120">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 120</span>
        &mdash; Молодцы! &mdash; похвалил пятикурсник, который раньше ни разу даже не заговаривал с Гарри.
        <span class="explanation">
  ...
  <section class="row" id="page-130">
    <div class="column">
      <p class="text">
        ...
        &mdash; Гарри! &mdash; Локонс крепко схватил Гарри за плечо. &mdash; Я понимаю. Раз подвергшись этому искушению, начинаешь прямо-таки жаждать славы. Я очень виноват перед тобой. Этот хмель должен был ударить тебе в голову [...]
        <span class="explanation">
  ...
  <section class="row" id="page-150">
    <div class="column">
      <p class="text">
        ...
        Он [Гарри] разлепил глаза и увидел Оливера Вуда. [...] &mdash; Тренировка! &mdash; решительно заявил Вуд. &mdash; Вставай!
        <span class="explanation">
  ...
  <section class="row" id="page-152">
    <div class="column">
      <p class="text">
        ...
        &mdash; Вот это да! Подожди! Я никогда в жизни не видел, как играют в квиддич! &mdash; И Колин вприпрыжку побежал вслед за Гарри.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
        Тебя вообще-то никто не звал. Это ещё раз подтверждает, что команде нужен тренер &mdash; в том числе, и для того, чтобы удалять с поля посторонних, которые могут не только мешать, но и шпионить, узнавая домашние заготовки команды.
      </p>
    </div>
  </section>

  <section class="row" id="page-154">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 154</span>
        Напротив них зевали два других охотника &mdash; Кэти Белл и Анджелина Джонсон.
      </p>
    </div>
    <div class="column column-60">
      <p class="comment">
        К слову, это тот вид спорта, где разделение команд по половому признаку было бы вполне оправданно. Как в футболе или хоккее.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-159">
    <div class="column">
      <p class="text">
        ...
        &mdash; Последняя модель. Появилась только месяц назад. [...] Она гораздо лучше «Нимбуса-2000».
        <span class="explanation">
    ...
    <div class="column column-60">
      <p class="bad">
        Ну, и какой смысл позволять разным командам закупать себе разные мётлы, если более новые модели дают немалое преимущество? Параллели с "Формулой-1" тут неуместны, потому что "Формула-1" &mdash; соревнование и гонщиков, и конструкторов. В книге же получается, что кто больше заплатил, тот и имеет большие шансы на победу. Pay to win.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-160">
    <div class="column">
      <p class="text">
        ...
        &mdash; А твоего мнения, грязнокровка, никто не спрашивает!
        <span class="explanation">
  ...
  <section class="row" id="page-161">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 161</span>
        &mdash; Отведем его [Рона] к Хагриду, это недалеко [...]
        <span class="explanation">
    ...
    <div class="column column-60">
      <p class="comment">
        А как насчёт больничного крыла?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-164">
    <div class="column">
      <p class="text">
        ...
        &mdash; А из кого выбирать-то? &mdash; Защиту... вишь ты... никто не хочет преподавать. Эта должность проклята [...]
        <span class="explanation">
  ...
  <section class="row" id="page-168">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 168</span>
    ...
    <div class="column column-60">
      <p class="bad">
        То есть сломанная палочка Рона творит невесть что, а сломанная палочка Хагрида работает как швейцарские часы.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-181">
    <div class="column">
      <p class="text">
        ...
        &mdash; Это для тебя немного, а для меня целый час тяжкого труда! &mdash; кричал Филч. &mdash; Итак, проступок &mdash; загрязнение замка. Рекомендуемое наказание…
        <span class="explanation">
    ...
    <div class="column column-60">
      <p class="meh">
        То есть Филч может самостоятельно придумывать наказания, даже за мелкие проступки вроде "пришёл в замок в грязной обуви"?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-211">
    <div class="column">
      <p class="text">
        ...
        &mdash; Просто беда, &mdash; сказал Рон, убрав рулетку. &mdash; Не хватает целых двадцати сантиметров…
        <span class="explanation">
  ...
  <section class="row" id="page-215">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 215</span>
        Все вы знаете, что школа «Хогвартс» основана более тысячи лет назад &mdash; точная дата неизвестна &mdash; четырьмя величайшими магами и волшебницами своего времени [...]
      </p>
    </div>
    <div class="column column-60">
      <p class="comment">
  ...
  <section class="row" id="page-227">
    ...
    <div class="column column-60">
      <p class="comment">
         Очень большой вопрос, станет ли он признаваться, что знает что-то о Тайной комнате, даже ближайшим друзьям. Они могут донести (хотя бы из страха), а могут просто по глупости проболтаться. Малфой засранец, но не дурак всё-таки. Поэтому даже если он скажет "это я не я открыл Комнату", то это ничего особенно не докажет.
      </p>
    </div>
  </section>
</article>
