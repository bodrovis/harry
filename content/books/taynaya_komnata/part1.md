...
<article class="book-main">
  ...
  <section class="row" id="page-26">
    ...
    <div class="column column-60">
      <p class="meh">
        Как? Добби сутками сидел у дома и ждал, когда доставят почту? Не надо только говорить, что есть заклинание, которое автоматически перенаправляет всю почту, адресованную конкретному человеку. Иначе это означает, что кто угодно может читать совиную почту.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-227">
    ...
    <div class="column column-60">
      <p class="comment">
         Очень большой вопрос, станет ли он признаваться, что знает что-то о Тайной комнате, даже ближайшим друзьям. Они могут донести (просто из страха), а могут по глупости проболтаться. Малфой засранец, но не дурак всё-таки. Поэтому даже если он скажет "это я не я открыл Комнату", то это ничего особенно не докажет.
      </p>
    </div>
  </section>
