...
<article class="book-main">
  ...
  <section class="row" id="page-5">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 5</span>
        [...] закончив первый курс Школы чародейства и волшебства «Хогвартс», что на волшебном языке значит «вепрь» [...]
      </p>
    </div>
    <div class="column column-60">
      <p class="comment">
        На каком ещё волшебном языке? "Hog" &mdash; это и на обычном английском значит "свинья", а "wart" &mdash; что-то типа "бородавки". Получается такая себе "свинья-бородавочник".
      </p>
    </div>
  </section>
