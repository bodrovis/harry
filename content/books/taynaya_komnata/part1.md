...
<article class="book-main">
  ...
  <section class="row" id="page-26">
    ...
    <div class="column column-60">
      <p class="meh">
        Как? Добби сутками сидел у дома и ждал, когда доставят почту? Не надо только говорить, что есть заклинание, которое автоматически перенаправляет все письма, адресованные конкретному человеку. Иначе это означает, что кто угодно может читать совиную почту.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-30">
    ...
    <div class="column column-60">
      <p class="bad">
        То есть вы не знаете, кто именно произнёс заклинание? Вы просто знаете, что в этом доме живёт ученик, и если там кто-то когда-то что-то наколдует, то этот ученик получит пиздюлей? Отлично, просто превосходно. То есть можно подбираться к домам недругов, колдовать рядом и убегать.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-27">
    ...
    <div class="column column-60">
      <p class="comment">
        За что? Он же должен следить, чтобы магические вещи не попадали к магглам, а не к другим магам. Или вообще нельзя зачаровывать никакие вещи? Как тогда работают всякие летающие мётлы, самопишущие ручки и прочее? Их ведь тоже как-то заколдовали и они тоже в теории могут попасть к маглам.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-54">
    <div class="column">
      <p class="text">
        ...
        — Наш и гномы глуповаты. [...] Услышат, что началось выдворение, так и лезут на поверхность. Нет, чтобы забиться поглубже в норы.
      </p>
    </div>
    <div class="column column-60">
      <p class="good">
  ...
  <section class="row" id="page-62">
    ...
    <div class="column column-60">
      <p class="comment">
        Мистер Уизли занимается работой с магглами, судя по всему, уже много лет. И он не знает как работает телефон? Папуасы из племени Мумбо-Юмбо &mdash; и те уже знают.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-66">
    <div class="column">
      <p class="text">
        ...
        Там они и тренировались, летая над лужайкой не очень высоко, чтобы магглы не заметили.
        <span class="explanation">
  ...
  <section class="row" id="page-107">
    ...
    <div class="column column-60">
      <p class="meh">
        Что это значит? Его заколдовали, позволив летать, встроили систему невидимости и возможность нести больше груза. Но во всём остальном это, вроде как, обычный автомобиль магглов. С чего у него появилось самосознание-то?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-125">
    ...
    <div class="column column-60">
      <p class="comment">
        Да вообще такое лучше открывать никак не в зале, где собралась вся школа. Неужели эта громовещалка не могла пару минут подождать, пока Рон не забьётся в какой-нибудь туалет?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-130">
    <div class="column">
      <p class="text">
        ...
        — Гарри! — Локоне крепко схватил Гарри за плечо. — Я понимаю. Раз подвергшись этому искушению, начинаешь прямо-таки жаждать славы. Я очень виноват перед тобой. Этот хмель должен был ударить тебе в голову [...]
        <span class="explanation">
  ...
  <section class="row" id="page-142">
    <div class="column">
      <p class="text">
        ...
        [...] рыцарь ордена Мерлина третьего класса, почетный член Лиги защитыот темных сил [...]
        <span class="explanation">
          Титулы Локонса.
        </span>
      </p>
  ...
  <section class="row" id="page-150">
    <div class="column">
      <p class="text">
        ...
        Он разлепил глаза и увидел Оливера Вуда. [...] — Тренировка! — решительно заявил Вуд. — Вставай!
        <span class="explanation">
  ...
  <section class="row" id="page-161">
    <div class="column">
      <p class="text">
        ...
        — Отведем его к Хагриду, это недалеко
        <span class="explanation">
          Рон блюёт слизнями.
        </span>
      </p>
  ...
  <section class="row" id="page-227">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Гарри и Ко хотят превратиться в слизеринцев и поспрашивать Малфоя о Тайной комнатею
        </span>
      </p>
    </div>
    <div class="column column-60">
