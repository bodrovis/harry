  ...
  <section class="row" id="page-30">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Министерство считает, что Гарри применял заклинание (это был Добби на самом деле).
        </span>
      </p>
    </div>
    <div class="column column-60">
  ...
  <section class="row" id="page-54">
    <div class="column">
      <p class="text">
        ...
        &mdash; Наш и гномы глуповаты. [...] Услышат, что началось выдворение, так и лезут на поверхность. Нет, чтобы забиться поглубже в норы.
      </p>
    </div>
    <div class="column column-60">
      <p class="good">
  ...
  <section class="row" id="page-62">
    <div class="column">
      <p class="text">
        ...
        Ну и ну! &mdash; удивился он, услыхав от Гарри про телефон. &mdash; Сколько же всего они напридумывали! А что еще им, бедным, остается делать без магии!
        <span class="explanation">
  ...
  <section class="row" id="page-67">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Это опять о бедности семьи Уизли
        </span>
      </p>
    </div>
    <div class="column column-60">
  ...
  <section class="row" id="page-68">
    <div class="column">
      <p class="text">
        ...
        &mdash; В самом деле? &mdash; с нескрываемым восторгом воскликнул мистер Уизли. &mdash; Я слыхал, там есть лестницы-чудесницы!
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-141">
    <div class="column">
      <p class="text">
        ...
        В этой сцене с юным Криви я был твоим щитом. Поскольку он фотографировал нас двоих, твои недруги не будут тебя корить: ишь какой, ставит себя выше других.
        <span class="explanation">
  ...
  <section class="row" id="page-150">
    <div class="column">
      <p class="text">
        ...
        Он разлепил глаза и увидел Оливера Вуда. [...] &mdash; Тренировка! &mdash; решительно заявил Вуд. &mdash; Вставай!
        <span class="explanation">
  ...
  <section class="row" id="page-161">
    <div class="column">
      <p class="text">
        ...
        &mdash; Отведем его к Хагриду, это недалеко
        <span class="explanation">
          Рон блюёт слизнями.
        </span>
      </p>
  ...
  <section class="row" id="page-168">
    <div class="column">
      <p class="text">
        ...
        Он был уверен, внутри безобидного на вид предмета скрыт обломок школьной волшебной палочки Хагрида.
        <span class="explanation">
