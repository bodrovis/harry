...
<article class="book-main">
  ...
  <section class="row" id="page-287-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 287</span>
        — А ты, Кэти, не можешь как-нибудь остановить кровь?<br>— Она только хуже идет, — хрипло сказала Кэти, — утираясь рукавом.
        <span class="explanation">
          Рон разбил Кэти нос.
        </span>
      </p>
  ...
  <section class="row" id="page-303">
    <div class="column">
      <p class="text">
        ...
        — Нет, «В» &mdash; «выше ожидаемого». И я [Джордж] всегда считал, что нам с Фредом должны ставить «В» по каждому предмету — мы превзошли все ожидания хотя бы потому, что явились на экзамен.
      </p>
    </div>
    <div class="column column-60">
      <p class="comment">
  ...
  <section class="row" id="page-309">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Амбридж говорил, что Квиррелл был хорошим преподом.
        </span>
      </p>
    </div>
    <div class="column column-60">
  ...
  <section class="row" id="page-317">
    <div class="column">
      <p class="text">
        ...
        — Разве не ясно? Ты, Гарри. [...]<br>— Что — я?<br>— Ты будешь учить нас защите от Темных искусств [...]
        <span class="explanation">
  ...
  <section class="row" id="page-330">
    <div class="column">
      <p class="text">
        ...
        — И ты убил василиска мечом из кабинета Дамблдора? — спросил Терри Бут.<br>— Ну... убил, да.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-333">
    <div class="column">
      <p class="text">
        ...
        — Хорошо бы, все написали свои имена, чтобы мы знали, кто присутствовал. И еще я думаю, — она [Гермиона] сделала глубокий вздох, — нам не стоит кричать об этом на каждом углу.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-369">
    <div class="column">
      <p class="text">
        ...
        — Эта комната — не просто дикая выдумка Добби; Дамблдор тоже знает о ней, он сказал при мне на Святочном балу. Лицо у Гермионы посветлело: <br>— Дамблдор сказал о ней?
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-372">
    <div class="column">
      <p class="text">
        ...
        — Я думаю, надо избрать руководителя.<br>— Гарри — руководитель [...]<br>— Да, но надо проголосовать по всей форме [...]
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-373-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 373</span>
        — Неужели ты думаешь, что Экспеллиармус поможет нам против Сам-Знаешь-Кого?<br>— Я применял его против него. [...] Оно спасло мне жизнь в июне.
        <span class="explanation">
  ...
  <section class="row" id="page-378">
    ...
    <div class="column column-60">
      <p class="comment">
        Серийный номер, как подсказывает название, &mdash; номер монеты, и этот номер уникален (такие номера проставляют, например, на купюрах). А один гоблин может отчеканить тысячи монет.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-382">
    <div class="column">
      <p class="text">
        ...
        Я не собирался.. соскользнул с метлы, вы просто не видели, а когда пытался влезть обратно, случайно пнул мяч.<br>— Ничего. [...] еще парочка таких случайностей, и игра у нас в кармане.
        <span class="explanation">
  ...
  <section class="row" id="page-425-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 425</span>
        — Кого [взяли в команду]?<br>— Джинни Уизли [...].
        <span class="explanation">
  ...
  <section class="row" id="page-430-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 430</span>
        — [Чжоу] глубоко опечалена смертью Седрика. Кроме того, я [Гермиона] думаю, она растеряна, потому что ей нравился Седрик, а теперь нравится Гарри, и она не может решить, кто ей нравится больше.
      </p>
    </div>
    <div class="column column-60">
      <p class="comment">
  ...
  <section class="row" id="page-461">
    ...
    <div class="column column-60">
      <p class="comment">
        Не сходи с ума. Змея была в Лондоне, минимум в сотне километров от школы. Трансгрессировать в школу нельзя, а быть в двух местах сразу ты, кажется, не умеешь.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-476">
    <div class="column">
      <p class="text">
        ...
        — Да... было такое. Вы учили нас в Хогвартсе, помните?<br>— Учил? — чуть-чуть забеспокоился Локоне. — Я? В самом деле?
        <span class="explanation">
  ...
  <section class="row" id="page-514">
    <div class="column">
      <p class="text">
        ...
        Если бы он [Гарри] не так беспокоился за Хагрида, то пожалел бы ее [Трелони], но уж коли одному из них быть выгнанным, то кому остаться — такого вопроса для Гарри не существовало.
        <span class="explanation">
  ...
  <section class="row" id="page-522">
    <div class="column">
      <p class="text">
        ...
        — Я давно хотела тебя спросить... Седрик... он вспоминал меня [Чжоу] перед смертью?
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-522-1">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Чжоу привязалась к Гарри с этим Седриком.
        </span>
      </p>
    </div>
    <div class="column column-60">
  ...
  <section class="row" id="page-529-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 529</span>
        — Я, что же, буду писать бесплатно?<br>— Ну да. [...] Иначе, как вы понимаете, я сообщу властям, что вы незарегистрированный анимаг.
        <span class="explanation">
  ...
  <section class="row" id="page-532">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Сказать о том, что у Гарри через час намечается интервью.
        </span>
      </p>
    </div>
    <div class="column column-60">
  ...
  <section class="row" id="page-535">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Гермиона спорит с Гарри о квиддиче.
        </span>
      </p>
    </div>
    <div class="column column-60">
  ...
  <section class="row" id="page-539">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Читают отзывы на интервью Гарри.
        </span>
      </p>
    </div>
    <div class="column column-60">
  ...
  <section class="row" id="page-541">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Очередной декрет Амбридж.
        </span>
      </p>
    </div>
    <div class="column column-60">
      <p class="comment">
        Ну, Амбридж просто тупая и не слышала про эффект Стрейзанд. Естественно, всем будет интересно, что в этом журнале написано. Иначе бы его и читать не стал бы никто. Правда весьма странно, что статье <b>внезапно</b> все вот так поверили (пусть не все, но многие). Полгода Гарри считали сумасшедшим, но стоило написать о нём какому-то Придире &mdash; всё, он сразу стал уважаемым членом общества с кристально чистой репутацией. К сожалению, в реальной жизни большинство бы только уверилось во мнении, что Поттер "того", раз никто, кроме Придиры, не печатает его интервью.
      </p>
    </div>
  </section>
