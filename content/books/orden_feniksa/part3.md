  ...
  <section class="row" id="page-797">
    <div class="column">
      <p class="text">
        ...
        Это и есть оружие, которого он [Волдеморт] так упорно добивался с момента своего возвращения, — знание того, как погубить тебя.
      </p>
    </div>
    <div class="column column-60">
      <p class="comment">
