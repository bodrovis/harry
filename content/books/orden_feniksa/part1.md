...
<article class="book-main">
  ...
  <section class="row" id="page-14">
    <div class="column">
      <p class="text">
        ...
        &mdash; Ей ты что-то не приказывал сгинуть. А как насчет «малыша» и «моего крохотулечки»? Может, мне так лучше к тебе обращаться?
  ...
  <section class="row" id="page-63-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 63</span>
        &mdash; Нет, но... он же поручил людям из Ордена Феникса за тобой смотреть…
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-186">
    <div class="column">
      <p class="text">
        ...
        &mdash; Ты не должен злоупотреблять положением старосты, Рон! &mdash; резко сказала ему Гермиона. &mdash; Малфой, конечно, ни капельки не будет им злоупотреблять, &mdash; саркастически откликнулся Рон.
      </p>
    </div>
    <div class="column column-60">
      <p class="bad">
