  ...
  <section class="row" id="page-66">
    <div class="column">
      <p class="text">
        ...
        — Кто входит в общество [орден феникса]?<br>— Совсем немного народу.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-97">
    <div class="column">
      <p class="text">
        ...
        — Вы оба [близнецы Уизли] трансгрессировали прямо мне на колени!<br>— В темноте, думаешь, легко?
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-108">
    <div class="column">
      <p class="text">
        ...
        — Ему [Кикимеру] нельзя дать свободу, ему слишком многое известно об Ордене, — сухо возразил ей [Гермионе] Сириус.
      </p>
    </div>
    <div class="column column-60">
      <p class="bad">
  ...
  <section class="row" id="page-132">
    <div class="column">
      <p class="text">
        ...
        — Но мне же сказали... [...] Быстрей, Гарри, нам следовало там быть пять минут назад!
        <span class="explanation">
  ...
  <section class="row" id="page-213">
    <div class="column">
      <p class="text">
        ...
        — [...] Читай себе «Ежедневный пророк», как твоя мать, что тебе мешает? Там найдешь все, что тебе следует знать.<br>— Не смей так про мою мать! — рассердился Симус.
        <span class="explanation">
  ...
  <section class="row" id="page-227">
    <div class="column">
      <p class="text">
        ...
        — Почему? Я только спросил ее...<br>— Разве непонятно было, что она [Чжоу] хочет говорить с Гарри, а не с тобой?<br>— Ну и говорила бы, разве я мешал?
        <span class="explanation">
  ...
  <section class="row" id="page-268">
    <div class="column">
      <p class="text">
        ...
        — Ни разу не видел, как ты играешь вратарем. Хорошо играешь?<br>— Вроде бы неплохо, — ответил Рон [...]. — Когда Чарли, Фред и Джордж тренировались в каникулы, я всегда был у них вратарем.
        <span class="explanation">
