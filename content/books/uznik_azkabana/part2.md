...
<article class="book-main">
  ...
  <section class="row" id="page-246">
    <div class="column">
      <p class="text">
        ...
        <span class="explanation">
          Имеется в виду гиппогриф, ударивший Малфоя.
        </span>
      </p>
    </div>
    <div class="column column-60">
  ...
  <section class="row" id="page-326">
    ...
    <div class="column column-60">
      <p class="good">
        И опять Снегг прав. Вообще не очень понятно, зачем Дамблдор с пафосным видом сообщил Гарри, что дескать его отец спас Снегга. Когда мы говорим "спас", то обычно имеем в виду нечто иное: вытащил из проруби, дал денег на операцию, помог справится с пагубной зависимостью и тому подобное.
      </p>
    </div>
  </section>
