...
<article class="book-main">
  ...
  <section class="row" id="page-48">
    ...
    <div class="column column-60">
      <p class="meh">
        И чего он ржал-то? Мог хотя бы попытаться объяснить, что его подставили, а Петтигрю, который это всё устроил &mdash; нелегальный анимаг. Что вообще за ненормальный будет смеяться при виде десятка зверски убитых людей?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-81">
    <div class="column">
      <p class="text">
        ...
        «Они думают, что я [Гарри] за себя не постою? Да я трижды остался жив после схватки с Воланде-Мортом! Что я, трус какой-то беспомощный?!»
        <span class="explanation">
  ...
  <section class="row" id="page-123">
    <div class="column">
      <p class="text">
        ...
        Пожалуйста, после того как разобьете первую чашку, возьмите вторую из голубого сервиза. [...]<br>И конечно, не успел Невилл взять в руки чашку с блюдцем, как раздался звук разбившегося фарфора. Профессор бросилась к нему со щеткой и совком для мусора [...]
        <span class="explanation">
  ...
  <section class="row" id="page-185">
    <div class="column">
      <p class="text">
        ...
        Привет от дементоров, Поттер! &mdash; крикнул он [Малфой], выходя из зала.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
