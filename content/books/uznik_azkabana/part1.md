...
<article class="book-main">
  ...
  <section class="row" id="page-209">
    ...
    <div class="column column-60">
      <p class="bad">
        А он и не виноват. Виноват капитан, который в очередной раз поджал хвост и, вместо того, чтобы настаивать на переигровке, покорно признал результат честным. В отличие от него, у Диггори есть яйца, хотя уже ему-то требовать аннулирования результата было абсолютно незачем.
      </p>
    </div>
  </section>
