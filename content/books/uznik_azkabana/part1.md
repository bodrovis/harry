...
<article class="book-main">
  ...
  <section class="row" id="page-121">
    ...
    <div class="column column-60">
      <p class="meh">
        По-моему, таким ученикам нужно настоятельно рекомендовать сменить выбранный предмет, причём как можно скорее: как только выяснится, что у них третий глаз открываться не желает. А то получается, что Гарри с Роном так и будут безрезультатно просиживать штаны на этих уроках и мешать другим.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-137">
    ...
    <div class="column column-60">
      <p class="bad">
        А я думаю, что сажать неподготовленного ученика без амуниции и страховки на летучую тварь &mdash; очень плохая идея.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-198">
    ...
    <div class="column column-60">
      <p class="comment">
        Интересно было бы узнать, что ты сделаешь. Одно неверное движение &mdash; и здравствуй, Азкабан.
      </p>
    </div>
  </section>
