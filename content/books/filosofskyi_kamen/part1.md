...
<article class="book-main">
  ...
  <section class="row" id="page-20">
    ...
    <div class="column column-60">
      <p class="meh">
        Ну, так воспитай его сам. Или отдай на воспитание кому-нибудь типа МакГонагалл. Это явно лучше, чем оставлять ребёнка всяким мудакам, которые его ненавидят. Может, Поттер и не вырастет зазнайкой, зато станет морально сломленным человеком. Психологические травмы детства вообще имеют свойство проявляться во взрослой жизни. Ещё раз: пока мы не обсуждаем некую <del>русскую</del> "защиту", которую Гарри получает в этом доме, потому что в данной книге о ней ни слова не сказано.
      </p>
    </div>
  </section>
