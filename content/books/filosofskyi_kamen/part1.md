...
<article class="book-main">
  ...
  <section class="row" id="page-19">
    <div class="column">
      <p class="text">
        ...
        Для него это лучшее место, &mdash; твердо ответил Дамблдор.
        <span class="explanation">
  ...
  <section class="row" id="page-28">
    <div class="column">
      <p class="text">
        ...
        Тридцать шесть, &mdash; произнес он грустным голосом, укоризненно глядя на отца и мать.
        <span class="explanation">
  ...
  <section class="row" id="page-38">
    <div class="column">
      <p class="text">
        ...
        Бразилия &mdash; вот куда я отправлюсь...
        <span class="explanation">
  ...
  <section class="row" id="page-83">
    ...
    <div class="column column-60">
      <p class="comment">
        Во всём этом списке нет учебников по обычным наукам вроде математики или естествознания. В дальнейшем об изучении подобных предметов также ничего не говорится. То есть после выпуска дети станут крутыми магами, но полными бестолочами, не умеющими сложить два и два, считающими, что Лондон &mdash; столица Парижа, и не знающими, кто такой Марк Твен.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-94">
    ...
    <div class="column column-60">
      <p class="meh">
        Так ведь золото &mdash; оно и в Африке золото. Или у магов и золото какое-то необычное, как у лепреконов? Но в дальнейшем мы узнаем, что лепреконское золото тоже существует, и оно по-настоящему фейковое. Короче, весьма мутная история.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-114">
    <div class="column">
      <p class="text">
        ...
        Так, какой у вас номер платформы? &mdash; поинтересовалась женщина.
        <span class="explanation">
  ...
  <section class="row" id="page-116">
    <div class="column">
      <p class="text">
        ...
        Все, что тебе надо сделать, &mdash; это пойти прямо через разделительный барьер между платформами девять и десять.
        <span class="explanation">
  ...
  <section class="row" id="page-130">
    <div class="column">
      <p class="text">
        ...
        Вчера я пытался ее заколдовать, чтобы она стала желтого цвета &mdash; я подумал, что так она будет выглядеть поинтереснее, &mdash; но ничего не получилось. Я тебе сейчас покажу, смотри…
        <span class="explanation">
  ...
  <section class="row" id="page-131-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 131</span>
        А я тут взяла из книг несколько простых заклинаний, чтобы немного попрактиковаться, &mdash; и все получилось.
        <span class="explanation">
          Гермиона хвастается.
        </span>
      </p>
  ...
  <section class="row" id="page-163-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 163</span>
        Капут драконис, &mdash; ответил Перси, и портрет отъехал в сторону, открыв круглую дыру в стене.
        <span class="explanation">
