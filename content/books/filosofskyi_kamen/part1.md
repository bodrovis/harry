...
<article class="book-main">
  ...
  <section class="row" id="page-19">
    <div class="column">
      <p class="text">
        ...
        &mdash; Для него это лучшее место, &mdash; твердо ответил Дамблдор.
        <span class="explanation">
  ...
  <section class="row" id="page-20">
    ...
    <div class="column column-60">
      <p class="meh">
        Ну, так воспитай его сам. Или отдай на воспитание кому-то типа МакГонагалл. Это явно лучше, чем оставлять ребёнка всяким мудакам, которые его ненавидят. Может, Поттер и не вырастет зазнайкой, зато станет морально сломленным человеком. Психологические травмы детства вообще имеют свойство проявляться во взрослой жизни. Ещё раз: пока мы не обсуждаем некую <s>русскую</s> "защиту", которую Гарри получает в этом доме, потому что в данной книге о ней ни слова не сказано.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-159-1">
    ...
    <div class="column column-60">
      <p class="bad">
        Ничего себе. А как насчёт того, чтобы также оградить этот этаж защитной магией? Туда ведь кто-нибудь даже по чистой случайности может забрести, особенно учитывая дебильную систему лестниц, которые постоянно меняют расположение. В общем, нам с самого начала показывают, что Дамблдор &mdash; весьма странный товарищ, который периодически принимает весьма спорные, если не сказать "глупые", решения. В дальнейшем мы к этому вернёмся ещё не раз.
      </p>
    </div>
  </section>
