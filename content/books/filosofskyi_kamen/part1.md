...
<article class="book-main">
  ...
  <section class="row" id="page-36">
    ...
    <div class="column column-60">
      <p class="bad">
        Таких змей не бывает в природе. Рекорд, как считается, поставил некий питон в 80-х годах, который вымахал до 12 метров, хотя эта информация официально не подтверждена; более реалистичным является значение 9 метров (между прочим, питоны более 4 метров уже считаются опасными для человека). Обычная машина среднего класса имеет длину 4 метра и ширину около 1.7 метров, то есть даже для того, чтобы обмотать её один раз, потребуется змея длиной почти 12 метров. Тем более, что буквально на следующей странице выясняется, что эта змея является удавом, которые больше 5 метров вообще не вырастают.
      </p>
    </div>
  </section>
