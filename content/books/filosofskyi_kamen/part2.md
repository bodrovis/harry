  ...
  <section class="row" id="page-222">
    <div class="column">
      <p class="text">
        ...
        &mdash; Она [Гериона] не знает про тролля. &mdash; Рон прикусил губу.<br>&mdash; Ладно, &mdash; отрывисто произнес он через несколько секунд [...]
        <span class="explanation">
