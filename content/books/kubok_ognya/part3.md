...
<article class="book-main">
  ...
  <section class="row" id="page-504">
    <div class="column">
      <p class="text">
        ...
        — Мистер Крауч, из Министерства! [...] Он болен, а может... Он в лесу, он хочет увидеть Дамблдора! Скажите пароль...<br>— Директор занят, Поттер, — сказал Снегг [...]
        <span class="explanation">
  ...
  <section class="row" id="page-559">
    <div class="column">
      <p class="text">
        ...
        [...] написала, что ты [Гарри] — единственный чемпион Хогвартса... — И он [Гарри] даже не удосужился опровергнуть ее слова! — громко воскликнул Амос Диггори [...]. — Но ты покажешь ему, Сед. Ты ведь однажды уже победил его.
        <span class="explanation">
  ...
  <section class="row" id="page-560">
    <div class="column">
      <p class="text">
        ...
        — Миссис Уизли, вы, конечно же, не поверили той ерунде, которую Рита Скитер настрочила для «Пророка»? Вы-то ведь знаете, что не влюблялся я [Поттер] в Гермиону!<br>— Конечно же, не поверила.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-592">
    <div class="column">
      <p class="text">
        ...
        — Должен признаться, друзья мои, я просчитался. Мое заклятие было отражено глупой жертвой этой женщины [матерью Поттера] и обратилось против меня самого.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-606">
    <div class="column">
      <p class="text">
        ...
        — Когда связь будет разорвана, мы [призраки] задержимся на мгновение... [...] ты должен добраться до портала, он вернет тебя в Хогвартс... Понял, Гарри?
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-620">
    ...
    <div class="column column-60">
      <p class="meh">
        Это выглядит не очень-то законно. Вы не хотите, случайно, позвать каких-нибудь официальных лиц? Это, кроме всего прочего, поможет защититься от обвинений в духе "вы фсё врёти, никокого Волдеморта мы ни знаим, а Седрик просто самоубился".
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-640">
    <div class="column">
      <p class="text">
        ...
        — Вы читали статьи Риты Скитер, мистер Фадж, — тихо произнес он [Гарри].
        <span class="explanation">
  ...
  <section class="row" id="page-641">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 641</span>
        — Эйвери... Нотт... Крэбб... Гойл...<br>— Ты просто повторяешь имена тех якобы Пожирателей смерти, кто был оправдан тринадцать лет назад!
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
