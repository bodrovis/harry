...
<article class="book-main">
  ...
  <section class="row" id="page-44">
    <div class="column">
      <p class="text">
        ...
        &mdash; Вы не увидите племянника до следующего лета, &mdash; произнес он [мистера Уизли] с мягким укором. &mdash; Право, стоило бы с ним попрощаться.
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-67-1">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 67</span>
        &mdash; Гарри сорвался с метлы, папа. [...] Это был несчастный случай. &mdash; Да, но ты-то не сорвался! &mdash; шумно развеселился Амос [...]
      </p>
    </div>
    <div class="column column-60">
      <p class="bad">
  ...
  <section class="row" id="page-78">
    <div class="column">
      <p class="text">
        ...
        Бразильский друг очень обиделся и прислал ему шляпу с заклятием &mdash; у Билли от нее уши свернулись.
        <span class="explanation">
