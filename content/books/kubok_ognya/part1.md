...
<article class="book-main">
  ...
  <section class="row" id="page-65">
    <div class="column">
      <p class="text">
        ...
        — Это может быть что угодно. Какие-нибудь простые, бесхитростные вещи, которые не вызвали бы у маглов желания поиграть с ними... Словом, на их взгляд, просто мусор.
        <span class="explanation">
  ...
  <section class="row" id="page-67-1">
    ...
    <div class="column column-60">
      <p class="bad">
        На фестивале мудаков ты был бы почётным президентом. Конечно же, при первом знакомстве надо вспоминать вот такие охренительные случаи, иначе просто никак. Хоть Седрик адекватный, правда проблема в том, что очень скоро он отбудет в страну вечной охоты.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-67-2">
    ...
    <div class="column column-60">
      <p class="bad">
        Блин, а ведь это взрослый мужик. У тебя реально других радостей в жизни больше нет? Нечем больше похвастать? Ощущение такое, что ты этот спич целый год готовил.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-71">
    ...
    <div class="column column-60">
      <p class="comment">
        Зачем подряжать на такое дело маггла?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-73-1">
    ...
    <div class="column column-60">
      <p class="meh">
        Смысла в этом никакого нет. Если кто-то о вашем таборе пронюхает, то сюда в любом случае набежит куча народу и вас раскроют. У вас тут палатки с павлинами, блэкджеком и блудницами, а также полёты на мётлах &mdash; о какой вообще конспирации может идти речь?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-83">
    ...
    <div class="column column-60">
      <p class="meh">
        Всем магам нужно было выдать простые инструкции, объясняющие как одеваются маглы. Тогда бы не пришлось разбираться с мужиками в ночнушках и прочими фриками.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-88">
    ...
    <div class="column column-60">
      <p class="meh">
        Вот этот стадион же они скрыли от магглов, иначе вся округа наблюдала бы полёты на мётлах. Но скрыть лагерь волшебников &mdash; уже никак. Ну, и опять же не говоря о том, что все могли телепортироваться сюда просто перед началом.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-101-1">
    ...
    <div class="column column-60">
      <p class="meh">
        Да ладно, вот это дела. Игру даже остановили, кто бы мог подумать. Помнится, когда Поттера убивал бладжер и скидывали с метлы, никто и не почесался.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-102">
    ...
    <div class="column column-60">
      <p class="comment">
        Логично было бы на время тайм-аута снитч отключать, а потом пускать заново, чтобы не давать преимущества подобным ушлым товарищам.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-111">
    ...
    <div class="column column-60">
      <p class="bad">
        Это возвращает нас к старому вопросу: неужели никто из соратников Волдеморта не понёс никакого наказания? Откуда их тут толпень-то такая взялась? Да этих маньяков должны были засадить пожизненно, либо, во всяком случае, конфисковать палочки. А ещё лучше &mdash; промыть мозги, чтобы они о своих тёмных делишках не вспоминали даже. Но, если так подумать, то столько их тут может быть в принципе? Человек сто? Двести? Пятьсот? А болельщиков сто тысяч. Даже если вычесть детей, женщин и всяких впечатлительных товарищей, то это всё равно куча народу. Чего они разбегаются так? И где служба безопасности? Где мракоборцы? Хоть кто-то должен ведь дежурить, это же гигантское сборище людей.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-121">
    ...
    <div class="column column-60">
      <p class="meh">
        Очередной мудак, который хочет повесить всех собак на школьников. Сколько там таких мудаков ещё припасено, интересно?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-136">
    ...
    <div class="column column-60">
      <p class="meh">
        Но кого это заботит, в принципе? Так, какой-то паршивый маггл.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-145-1">
    ...
    <div class="column column-60">
      <p class="bad">
        Пардон, что? Взяла денег из сейфа? То есть любой умник может взять из сейфа Поттера деньги? Миссис Уизли ему даже не родственница.
      </p>
    </div>
  </section>
