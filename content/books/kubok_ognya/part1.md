...
<article class="book-main">
  ...
  <section class="row" id="page-41-1">
    ...
    <div class="column column-60">
      <p class="meh">
        А, ну да. Ты вот так запросто нарушил требования министерства, запрещающие подключать камины маглов к сети пороха. Тебе истории с летающей машиной было мало?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-71-1">
    ...
    <div class="column column-60">
      <p class="meh">
        У вас этот дядька к концу мероприятия станет овощем и составит компанию Локонсу в психушке. Вместо того, чтобы набирать кучу эрзац-людей в чёрном для стирания памяти, лучше было бы их самих и нанять в качестве привратников.
      </p>
    </div>
  </section>
