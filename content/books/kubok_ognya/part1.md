...
<article class="book-main">
  ...
  <section class="row" id="page-158">
    ...
    <div class="column column-60">
      <p class="meh">
        То есть школа воспитывает тёмных магов и это никого не волнует, получается?
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-157-1">
    ...
    <div class="column column-60">
      <p class="comment">
        Ну, маггл-то увидит, но ведь волшебники &mdash; нет. Значит, от представителей магического мира он спрятан быть никак не может.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-177">
    ...
    <div class="column column-60">
      <p class="comment">
        Заходят в бар бьюти-блоггер, пикапер и крипто-инвестор, а бармен им говорит: мы лиц до восемнадцати лет не обслуживаем.
      </p>
    </div>
  </section>
  ...
  <section class="row" id="page-178">
    ...
    <div class="column column-60">
      <p class="bad">
        Серьёзно что ли? А нельзя было придумывать такие испытания, где школьники бы не умирали? И какой родитель в здравом уме позволит своему ребёнку участвовать в таком? И как это преподы допустили?
      </p>
    </div>
  </section>
