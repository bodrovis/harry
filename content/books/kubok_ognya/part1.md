...
<article class="book-main">
  ...
  <section class="row" id="page-177">
    ...
    <div class="column column-60">
      <p class="comment">
        Заходят в бар бесконечное количество математиков. Первый говорит: "Мне литр пива!". Второй: "А мне половину литра пива!". Третий: "А мне половину от половины литра!". Бармен: "Не-не-не, ребята, знаю я ваши приколы, вот вам литр пива на всех и валите отсюда".
      </p>
    </div>
  </section>
