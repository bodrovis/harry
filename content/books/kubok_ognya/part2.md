...
<article class="book-main">
  ...
  <section class="row" id="page-261">
    <div class="column">
      <p class="text">
        ...
        &mdash; Может быть, ты просил кого-то из старших бросить в Кубок твое имя?
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-263-3">
    <div class="column">
      <p class="text">
        <span class="page-num">СТР 263</span>
        &mdash; Мне мерещится? [...] Фантазия разыгралась? Да поймите, подложивший в Кубок имя Потгера обладает огромной волшебной силой! &mdash; А доказательства, мсье?
        <span class="explanation">
  ...
  <section class="row" id="page-286">
    <div class="column">
      <p class="text">
        ...
        &mdash; Отменно омерзительна, &mdash; блеснул очками Дамблдор. &mdash; Особенно меня потешил мой собственный образ выжившего из ума болтуна.
        <span class="explanation">
  ...
  <section class="row" id="page-302">
    <div class="column">
      <p class="text">
        ...
        &mdash; Назад, Хагрид! [...] Сам знаешь, они стреляют огнем на расстояние семь метров. А эта хвосторога на все пятнадцать.
        <span class="explanation">
  ...
  <section class="row" id="page-303">
    <div class="column">
      <p class="text">
        ...
        &mdash; Не знал, что ты ее приведешь. [...] Чемпионам не положено знать, что им предстоит. А она, конечно же, своему расскажет. &mdash; Просто подумал, ей будет приятно взглянуть [...]
        <span class="explanation">
  ...
  <section class="row" id="page-371">
    <div class="column">
      <p class="text">
        ...
        &mdash; Конечно. У меня тоже кое-что есть... для тебя.<br>Гарри соврал, он ничего не припас для Добби, но поспешил открыть чемодан и достал оттуда пару старых желтых носков дяди Вернона.
        <span class="explanation">
  ...
  <section class="row" id="page-383">
    <div class="column">
      <p class="text">
        ...
        &mdash; Он из Дурмстранга &mdash; вот что! Он соперник Гарри. И нашей школы. А ты... [...] Ты братаешься с врагом &mdash; вот что!
        <span class="explanation">
  ...
  <section class="row" id="page-384">
    <div class="column">
      <p class="text">
        ...
        &mdash; Ты, наконец, пригласишь меня танцевать? &mdash; спросила Падма. &mdash; Нет, &mdash; отрезал Рон [...]
      </p>
    </div>
    <div class="column column-60">
      <p class="meh">
  ...
  <section class="row" id="page-388">
    <div class="column">
      <p class="text">
        ...
        &mdash; Как она ушла, отец долго убивался. Крохотной был такой. Я его в шесть лет на комод сажал, коли надоест шибко.
        <span class="explanation">
  ...
  <section class="row" id="page-399">
    <div class="column">
      <p class="text">
        ...
        &mdash; Что значит, «все его терпеть не могут»? А о нем тут что написано? &mdash; Гарри указал на Крэбба. &mdash; Когда это его червь кусал? У червей и зубов-то нет!
        <span class="explanation">
  ...
  <section class="row" id="page-428">
    <div class="column">
      <p class="text">
        ...
        &mdash; А то, что Дамблдор будет не прочь узнать, у кого зуб на этого паренька
        <span class="explanation">
